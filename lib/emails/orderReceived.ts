...
export function orderReceivedHtml(d: OrderReceivedData): string {
  ...
  return `<!DOCTYPE html><html lang="en"><head><meta charset="UTF-8"/><meta name="viewport" content="width=device-width,initial-scale=1.0"/><title>New Order — FoodGenie</title></head>
...
<table width="100%" cellpadding="0" cellspacing="0" style="max-width:600px;background:#fff;border:1px solid rgba(201,169,110,0.28);box-shadow:0 4px 24px rgba(0,0,0,0.07);">
  ...
  <tr><td style="padding:36px 44px 24px;">
    <p style="margin:0 0 4px;font-size:0.55rem;letter-spacing:0.3em;text-transform:uppercase;color:#c9a96e;">New Order Received</p>
    <h1 style="margin:0 0 4px;font-size:1.9rem;font-weight:700;color:#1a1a1a;letter-spacing:0.06em;">FoodGenie</h1>
    <p style="margin:0;font-size:0.7rem;color:rgba(0,0,0,0.35);font-style:italic;">Culinary Magic, Delivered</p>
  ...
  <tr><td style="padding:0 44px 12px;">
    <p style="margin:0 0 4px;font-size:0.55rem;letter-spacing:0.28em;text-transform:uppercase;color:#c9a96e;">Subscription ID</p>
    <p style="margin:0;font-size:1.4rem;font-weight:700;color:#c9a96e;font-family:'Georgia',serif;letter-spacing:0.06em;">${d.subscriptionId}</p>
  </td></tr>

  <tr><td style="padding:0 44px 28px;">
    <p style="margin:0 0 12px;font-size:0.55rem;letter-spacing:0.28em;text-transform:uppercase;color:#c9a96e;">Order Details</p>
  ...
  <tr><td style="padding:0 44px 32px;">
    <table cellpadding="0" cellspacing="0" style="border-left:2px solid rgba(201,169,110,0.4);padding-left:14px;">
      <tr><td style="font-size:0.72rem;color:rgba(0,0,0,0.4);line-height:1.8;font-style:italic;">
        A new subscription has been placed and payment confirmed. Please review and activate from the admin panel.
      </td></tr>
    </table>
  </td></tr>
